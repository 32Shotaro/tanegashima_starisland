    ...
    <div class="cols">
      <div class="col-12">
        ...
        <ul class="d-f fxw-w jc-c g10 sm-g8 pt70 sm-pt45 sm-mlr-20">
          <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight" href="/spot">すべて</a></li>
          <?php
          ...
          if (!empty($terms) && !is_wp_error($terms)) : ?>
            <?php foreach ($terms as $term) : ?>
              <?php $is_active = is_tax('spots-cat', $term->slug) ? ' is-active' : ''; ?>
              <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight<?= $is_active; ?>" href="<?= esc_url(get_term_link($term)); ?>"><?= esc_html($term->name); ?></a></li>
            <?php endforeach; ?>
          <?php else : ?>
          <?php endif; ?>
        </ul>
