...
<main class="main">
    ...
    <div class="cols">
      <div class="col-12">
        ...
        <ul class="d-f fxw-w jc-c g10 sm-g8 pt70 sm-pt45 sm-mlr-20">
          <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight is-active" href="/">すべて</a></li>
          <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight" href="#">南種子町</a></li>
          <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight" href="#">中種子町</a></li>
          <li><a class="d-f ai-c cg20 bd bdw1 bdc-butter bdrs-max h30 plr15 fz85 lh12 td-n hov-bgc-typography-alpha5 hov-c-butter active-bgc-butter active-c-midnight" href="#">西之表市</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <!-- 星空の周遊マップ -->
  <div class="pt160 md-fz110 sm-pt60 pb200 md-pb130 sm-pb60 js-scroll scroll-view">
    <div class="cols">
      <div class="col-12">
        <a class="d-f md-fxd-c ai-c jc-sb rg20 bd bdw1 bdc-typography mt20 sm-mt40 sm-mlr-10 pt60 md-pt45 sm-pt30 pb60 md-pb40 sm-pb20 plr65 md-plr45 sm-plr30 td-n pos-r hov-hook hov-bdc-butter hov-c-butter hov-animation-bgfill" href="<?= get_template_directory_uri(); ?>/assets/pdf/map.pdf" target="_blank" rel="noopener">
          ...
          <div class="md-w-max">
            ...
            <div class="pt15 sm-pt0 ta-r">
              <div class="d-if ai-c cg20 sm-cg15 td-n hov-c-butter hov-hook">
